  ...
  return (
    ...
    >
      <motion.div
        ...
        initial="offscreen"
        animate="onscreen"
        className="container mx-auto flex flex-wrap md:px-10 lg:px-16 xl:px-20 2xl:px-20 flex-col md:flex-row items-center justify-between"
      >
        <Link
          href="/"
        ...
        <div className="">
          <BtnPrimary
            ...
            componentStyle={`${btnColor} font-satoshi font-medium py-1 px-2 lg:py-2 lg:px-3 mr-2 cursor-pointer`}
          >
            EN
          </BtnPrimary>
          <BtnPrimary
            onClick={handleClickWhatsapp}
            componentStyle={`${btnColor} font-satoshi font-medium py-1 px-2 lg:py-2 lg:px-6 cursor-pointer`}
          >
            Whatsapp
          </BtnPrimary>
        </div>
