...
export default function HeroSection() {
  return (
    <section
      className="text-gray-600 body-font border-b-2"
      style={{
    ...
    >
      <div className="container h-screen mx-auto flex px-3 md:px-5 xl:px-16 2xl:px-20 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <h1 className="font-satoshi tracking-tight uppercase title-font sm:text-5xl text-3xl font-extrabold text-gray-900 mb-8">
